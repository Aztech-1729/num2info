...
async def main():
    ...
    # Configure timeouts to prevent connection issues
    application = (
        Application.builder()
        .token(config.BOT_TOKEN)
        .get_updates_request_timeout(30)  # Timeout for get_updates requests
        .get_updates_connection_pool_size(8)  # Connection pool size
        .build()
    )
